      ...
      <div className="max-w-7xl mx-auto px-6">
        <Reveal>
          <div className="text-center mb-20">
            <div className="text-xs tracking-[0.5em] text-cyan-300/80 font-display mb-4">[ 03 ] TRANSMISSION</div>
            ...
            <p className="mt-6 text-foreground/60 max-w-2xl mx-auto">
              Reach out and let's engineer your digital presence.
            </p>
          </div>
        </Reveal>
            ...
            return (
              <Reveal key={c.label} delay={i * 150}>
                <a
                  ...
                  rel="noreferrer"
                  className="group block h-full glass rounded-2xl p-8 transition-all hover:-translate-y-2 hover:border-cyan-400/60 hover:shadow-[0_0_40px_rgba(0,229,255,0.25)]"
                >
